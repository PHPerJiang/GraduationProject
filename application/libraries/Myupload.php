...
class Myupload{
    ...
    public function __construct(){
        $CI = &get_instance();
        $this->path = $CI->config->item('upload_path');
        $this->max_size = $CI->config->item('upload_max_size');
        $this->mime = $CI->config->item('upload_mime');
    }
...
$upload = new upload();
if($file_name = $upload->up($_FILES['picName'])){
