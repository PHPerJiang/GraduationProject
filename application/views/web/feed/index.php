...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700,800' rel='stylesheet' type='text/css'>
        <link rel="stylesheet" href="<?php echo site_url('assets/css/home-main.css')?>">
...
<!---//End-header---->
<div class="copyrights">Collect from <a href="" >PHP</a></div>
<!---start-content---->
<div class="content">
	<div class="wrap">
...
<!---//End-content---->
<!----wookmark-scripts---->
<script src="<?php echo site_url('assets/js/jquery.imagesloaded.js')?>"></script>
<script src="<?php echo site_url('assets/js/jquery.wookmark.js')?>"></script>
<script type="text/javascript">
    (function ($){
        var $tiles = $('#tiles'),
            $handler = $('li', $tiles),
